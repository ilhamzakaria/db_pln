...
<form method="POST" action="media_admin.php?module=register_pelanggan" align="center" onsubmit="return validasi(this)">
	<table cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			...
			<td>:</td>
			<td><input type="text" name="inputnometer" size="40%"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>:</td>
			<td>
				<select name="inputkodetarif" style="width: 60%;">
					...
					?>
					<option value=<?php echo $dataForeign['KodeTarif']?> > <?php echo $dataForeign['Daya']?> </option>
					<?php
						}
					?>
				</select>
